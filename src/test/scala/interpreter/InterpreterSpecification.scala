...
import main.BoxHelpers.createBox
import main.ErgoProvingInterpreter
import scapi.sigma.DLogProtocol.ProveDlog
import scapi.sigma.ProveDiffieHellmanTuple

class InterpreterSpecification extends PropSpec
  with PropertyChecks
  ...
  property("Evaluation - Crowdfunding Example") {
    ...
    compiledScript.evaluated shouldBe false
